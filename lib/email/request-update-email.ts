...
export async function sendRequestUpdateEmail({
  ...
  <p><strong>2. ${
    email
      ...
      : `This is the awkward step. So, we don't have their email.</strong> We advised them to follow <a href='http://opendoorsformaui.org/edit/thank-you?email=null'>these instructions</a>. So, now, we wait.`
  }</p>
