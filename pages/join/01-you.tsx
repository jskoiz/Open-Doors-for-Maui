...
export default function JoinStep1({ pageTitle }) {
  ...
  return (
    <>
      ...
      <Heading>Mahalo for your willingness to help. </Heading>
      <Subheading centered>
        Fill out the form below to share details about yourself and the space
        you can offer. For specific questions please email
